...
;
// Constants
const API_KEY = process.env.NEXT_PUBLIC_TMDB_API_KEY || "fbd1edacbe4e94f662341a99cd3be594";
...
function SearchPage() {
    ...
    const { data: results = [], isLoading, error, isError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "search",
            debouncedQuery
        ],
...
//# sourceMappingURL=src_72a08ddf._.js.map