...
function MoviesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MoviesPage.useEffect": ()=>{
            const fetchMovies = {
                "MoviesPage.useEffect.fetchMovies": async ()=>{
                    setIsLoading(true);
                    setError(null);
                    try {
            ...
            }["MoviesPage.useEffect.fetchMovies"];
            fetchMovies();
        }
    }["MoviesPage.useEffect"], []);
...
_s(MoviesPage, "6Mj7TL6N7p4mAKDtkL7UglCE+N0=");
_c = MoviesPage;
var _c;
...
//# sourceMappingURL=src_18ec0ae3._.js.map