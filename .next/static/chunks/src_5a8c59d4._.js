...
"[project]/src/app/my-list/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function MyFilmsList() {
    ...
    const usermovieIds = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "MyFilmsList.useAppSelector[usermovieIds]": (state)=>state.auth.user?.favoriteFilms
    }["MyFilmsList.useAppSelector[usermovieIds]"]);
    console.log(movies);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MyFilmsList.useEffect": ()=>{
            const fetchSelectedMovies = {
                "MyFilmsList.useEffect.fetchSelectedMovies": async ()=>{
                    setIsLoading(true);
                    setError(null);
                    try {
                        const results = await Promise.all((usermovieIds ?? []).map({
                            "MyFilmsList.useEffect.fetchSelectedMovies": async (id)=>{
                        ...
                        }["MyFilmsList.useEffect.fetchSelectedMovies"]));
                        setMovies(results);
                    } catch (err) {
    ...
    const movieLists = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MyFilmsList.useMemo[movieLists]": ()=>{
...
_s(MyFilmsList, "cAunZByc5B8mHG6XpOXmFKiahu4=", false, function() {
    return [
...
_c = MyFilmsList;
var _c;
__turbopack_context__.k.register(_c, "MyFilmsList");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_5a8c59d4._.js.map