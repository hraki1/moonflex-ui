...
function Home() {
    ...
    const auth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$hooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"])({
        "Home.useAppSelector[auth]": (state)=>state.auth
    }["Home.useAppSelector[auth]"]);
    console.log(auth);
...
_s(Home, "tWoMJCQHmpg2KLA17Qx7OWqijCE=", false, function() {
    return [
...
//# sourceMappingURL=src_afb66fb6._.js.map